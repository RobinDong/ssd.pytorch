...
class SSDResNeXt(nn.Module):
    ...
    def __init__(self, phase, size, extras, head, num_classes):
        super(SSDResNeXt, self).__init__()
        self.phase = phase
        ...
        # SSD network
        self.backbone = resnet.resnext50_32x4d(num_classes=num_classes)
    ...
    def forward(self, x):
        ...
        _, _, endpoints = self.backbone(x)
        sources.append(endpoints[0])
...
def build_ssd_resnext(phase, size=300, num_classes=21):
